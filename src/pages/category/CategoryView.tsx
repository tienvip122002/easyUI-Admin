  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">View Category</h1>
        <button
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm text-gray-900 dark:text-white">{category.status}</dd>
          </div>
          <div className="col-span-2">
            <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Description</dt>
            <dd className="mt-1 text-sm text-gray-900 dark:text-white">{category.description}</dd>
          </div>
          <div>
